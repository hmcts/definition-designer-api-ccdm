...
public class EnumUtilTest {
    ...
    public void testEnumValueDoesNotExistThrowsIllegalArgumentException() {
        ...
        try {
            ...
            assertEquals("No enum constant uk.gov.hmcts.ccd.definition.designer.repository.SecurityClassification.XXXX",
                e.getMessage()
            );
            throw e;
        }
    ...
    public void testEnumConstantBlankThrowsIllegalArgumentException() {
        ...
        try {
            ...
            assertEquals("No enum constant uk.gov.hmcts.ccd.definition.designer.repository.SecurityClassification.   ",
                e.getMessage()
            );
            throw e;
        }
