...
import uk.gov.hmcts.ccd.definition.designer.repository.PostgreSQLEnumType;
...
@TypeDefs({
    ...
    @TypeDef(
        ...
        parameters = @Parameter(name = "type",
                                value = "uk.gov.hmcts.ccd.definition.designer.repository.entity.DefinitionStatus")
    )
})
